...
public class DataInitialization implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void criarUsuario() {
        ...
        salvaUsuario(new Usuario("admin","Administrador", "administrador@gmail.com", passwordEncoder.encode("123"), "3232sdsd", d.getId()), "ADM");
        salvaUsuario(new Usuario("user","Teste", "teste@gmail.com", passwordEncoder.encode("123"), "3232sdsd", asb.getId()), "USER");
    }
