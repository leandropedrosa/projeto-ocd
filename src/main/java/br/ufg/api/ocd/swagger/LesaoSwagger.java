...
@Api(value = "/api/OCD/lesao", description = "Manter Lesão", produces = "application/json")
public interface LesaoSwagger {

    @ResponseStatus(HttpStatus.OK)
    @ApiOperation(value = "Busca todos as Lesões pelo tipo de lesão", notes = "Busca todos os Lesãos pelo tipo de lesão", response = Lesao.class)
    @ApiResponses({
